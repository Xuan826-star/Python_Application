...
class ValidationPipeline:
    ...
    def process_item(self,item,spider):
        print(f'process deferred:{item}')
        d = deferToThread(self.task_item, item)
        self.processing_tasks.append(d)
        d.addCallback(self.handle_processed_item)
        return d

    def handle_processed_item(self, item):
        print(f'handle processed item:{item}')
    ...
    def close_spider(self, spider):
        return defer.DeferredList(self.processing_tasks)
